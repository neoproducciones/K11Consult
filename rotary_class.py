...
class RotaryEncoder:
    ...
    def __init__(self, pinA, pinB, button, callback):
        ...
        GPIO.add_event_detect(self.pinA, GPIO.FALLING, callback=self.switch_event, bouncetime=10)
        GPIO.add_event_detect(self.pinB, GPIO.FALLING, callback=self.switch_event, bouncetime=10)
